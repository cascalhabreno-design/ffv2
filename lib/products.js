...
// Ao alterar um preço aqui, altere também o valor exibido em loja.html
// (o card correspondente). Este arquivo é o que define o que é cobrado.
const DENOMINACOES = {
  'dia-1060':  { diamantes: 1060,  bonus: 212,  precoEmCentavos: 1490 },  // R$ 14,90
  'dia-2180':  { diamantes: 2180,  bonus: 654,  precoEmCentavos: 1990 },  // R$ 19,90
  'dia-5600':  { diamantes: 5600,  bonus: 1120, precoEmCentavos: 3779 },  // R$ 37,79
  'dia-22400': { diamantes: 22400, bonus: 4480, precoEmCentavos: 14990 }, // R$ 149,90
};
...
const ORDER_BUMPS = {
  ...
  'bmp-2180-diamantes':     { nome: '2180 Diamantes Desconto',       precoEmCentavos: 1528 },
  'bmp-conjunto-naruto':    { nome: 'Conjunto Naruto',               precoEmCentavos: 2173 },
  'bmp-conjunto-sasuke':    { nome: 'Conjunto Sasuke',               precoEmCentavos: 1978 },
  'bmp-conjunto-kakashi':   { nome: 'Conjunto Kakashi',              precoEmCentavos: 1990 },
